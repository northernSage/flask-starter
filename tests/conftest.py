...
class AuthActions:
    ...
    def __init__(self, client, username='test', password='test', email='test@gmail.com'):
        self._email = email
        self._client = client
    ...
    def login(self):
        rv = self._client.post('/auth/login/', data={
    ...
    def register(self):
        rv = self._client.post('/auth/register/', data={
            'username': self._username,
            'email': self._email,
            'password': self._password,
    ...
    def logout(self):
        rv = self._client.get('/auth/logout/')
        self._is_authenticated = False
